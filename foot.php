              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <tbody>
                    ...
                    //$rslt= mysql_query("select *  from $tbl where observation=''");
                     ...
                     $rslt= mysql_query("select * from $mtbl as a inner join $tbl as b on a.regnum=b.regnum where b.regnum IN (select regnum FROM $tbl WHERE confirm='')");
                 
                    while ($row = mysql_fetch_array($rslt)) {
                    ?>
                      <tr>
                          <td><?php echo $code." ".$row['regnum']."/".$row['month']."/".$row['year'] ?> </td>
                    ...
                    <td><?php echo $row['crtby'].$row['crton']?></td>
                     ...
                     <td>
                         ...
                         <button type="submit" name="confirm" class="templatemo-blue-button width-50">Confirm</button>
                         </form>
                     </td>
