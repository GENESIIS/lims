...
'$dob' , '$gender' , '$number' , '$edu' , '$fmemb' , '$pemp' , '$emp'  , 
...
VALUES ('$month','$yr', '$cdate' , '$district', ' $title', '$fname', '$lname',
    '$address','$nic','$national','$religion', '$dob' , '$gender' , '$number' , '$edu' , '$fmemb' , '$pemp' , '$emp'  , 
                 '$adate' , '$doc' , '$hos' ,'$anyother','$aftramp','$voc', '$acause' , '$arm','$elbow','$cdate','$user')";
                    ...
                    $table = "memberother";
                          ...
                          `cause`, `other`, `whichlego`, `whicharmo`,
                                    crton,crtby )
             VALUES ('$month','$yr', '$cdate' , '$district', ' $title', '$fname', '$lname', '$address', 
                 '$nic','$national','$religion', '$dob' , '$gender' , '$number' , '$edu' , '$fmemb' , '$pemp' , '$emp'  , 
...
//      $sql = "INSERT INTO $table (regnum,month,year, date ,district ,title ,fname ,lname,address ,age ,sex ,phone,education ,fammem ,presntemp, prioremp,surgerydate,reason ,surgeonhospitle,whichleg ,bouk,crton,crtby )
