...
$code = "J.F /";
        ...
        $code = "O.A /";
			 ...
			 ?>
                    ...
                    <tr>
                         <td class="col-lg-3 col-md-3">District</td>
                      <td class="col-lg-3 col-md-3"> <?php echo $rows['district'] ?></td> 
                      <td class="col-lg-3 col-md-3">Social Service No </td>
                    ...
                    <tr>
                      ...
                      <td class="col-lg-3 col-md-3">Name</td>
                      <td class="col-lg-3 col-md-3"> <?php echo $rows['title']. ". ". $rows['fname'] . " ". $rows['lname']  ?></td>   
                      <td class="col-lg-3 col-md-3">Address</td>
                      <td class="col-lg-3 col-md-3"> <?php echo $rows['address'] ?></td>
                    </tr>   
					
			<tr>
                      <td class="col-lg-3 col-md-3">Age</td>
                      <td class="col-lg-3 col-md-3"><?php 
                      $yr = date("Y");
                      $dyr = explode("-", $rows['dob']);
                      echo $yr-$dyr[0] ?></td> 
                      <td class="col-lg-3 col-md-3">Gender</td>
                      <td class="col-lg-3 col-md-3"> <?php echo $rows['sex'] ?></td>
                    </tr> 
				
					
					<tr>
                  
                      <td <td class="col-lg-3 col-md-3">Gender</td>
                      <td class="col-lg-3 col-md-3"> <?php echo $rows['sex'] ?></td>
                      <td>Phone number</td>
...
<!--            end of form-->
            ...
            <br>
           <p style="page-break-after:always;">Break from here</p>
            
            <div class="page">
                <?php 
if ($table=="memberfoot") {
    ?>
<!--                job record sheet for foot-->
...
<!--                         <tr>
            ...
            <?php
//            meka foot eka above knee ekak nam
                  if ($rows['aouk']=="Above Knee") {
                      ?>
            <img src="images/above1.jpg" alt="first" style="width:600px;height:500px;">
             <img src="images/tbl1.jpg" alt="first" style="width:600px;height:500px;">
                      <?php
                  }  else {
//                      meka below nam
                      ?>
                       <img src="images/ab.jpg" alt="first" style="width:800px;height:600px;">
                       <img src="images/tbl1.jpg" alt="first" style="width:800px;height:500px;">
                  <?php
                       }
}elseif ($table=="memberarm") {
